...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--data_path', type=str, default='./Data_folder/train/', help='Train images path')          # 非帕金森樣本路徑
        parser.add_argument('--parkinson_data_path', type=str, default='./Data_folder/train/', help='Train images path')# 帕金森樣本路徑
        ...
        parser.add_argument('--patch_size', default=[64, 96, 32], help='Size of the patches extracted from the image')
        ...
        parser.add_argument('--new_resolution', default=(1.6, 1.6, 1.6), help='New resolution (if you want to resample the data again during training')
