...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--val_path', type=str, default='./Data_folder/test_parkinson/CT', help='Validation images path')
        parser.add_argument('--batch_size', type=int, default=8, help='input batch size')
        parser.add_argument('--patch_size', default=[72, 88, 40], help='Size of the patches extracted from the image')
        ...
        parser.add_argument('--new_resolution', default=(2.5, 2.5, 2.0), help='New resolution (if you want to resample the data again during training')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints_0728', help='models are saved here')
