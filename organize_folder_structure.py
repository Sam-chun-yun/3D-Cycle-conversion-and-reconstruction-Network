...
parser.add_argument('--images', default=r'D:\Desktop\MRI', help='path to the images a (early frames)')
parser.add_argument('--labels', default=r'D:\Desktop\SPECT', help='path to the images b (late frames)')
parser.add_argument('--split', default=0, help='number of images for testing')
parser.add_argument('--resolution', default=(1.8, 1.8, 1.8), help='new resolution to resample the all data')
...
if __name__ == "__main__":
    ...
    reference_image = resample_sitk_image(reference_image, spacing=args.resolution, interpolator='linear') #重採樣，使圖像大小相同
